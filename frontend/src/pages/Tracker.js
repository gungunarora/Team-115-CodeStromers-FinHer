...
import BudgetForm from './TrackerForm';
import BudgetTable from './TrackerTable';
...
const Tracker = () => {
    ...
    return (
        <div>
            ...
            <BudgetForm onEntryAdded={fetchEntries} />
            <BudgetTable entries={entries} onEntryDeleted={fetchEntries} />
        </div>
    );
};
